...
// Fetch all maths videos
$query = "SELECT * FROM videos WHERE category = 'maths'";
$stmt = $pdo->query($query);
$mathVideos = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    <header class="header">
        <a href="#" class="logo"> <i class="fas fa-school"></i><marquee>"EDU-FUN - An E-Learning Platform For KGStudents"</marquee></a>
        <nav class="navbar">
            <a href="mathsdash.php">Dashboard</a>
            <a href="logout.php">Logout</a>
        </nav>
    </header>
    <div class="mvid">
        <h1>Maths Videos</h1>
        <?php if (!empty($mathVideos)): ?>
            <ul>
                <?php foreach ($mathVideos as $video): 
        ...
        <?php else: ?>
            <p style="text-align: center; font-size: 18px; color: #888;">No maths videos found.</p>
        <?php endif; ?>
    </div>
    <script>
