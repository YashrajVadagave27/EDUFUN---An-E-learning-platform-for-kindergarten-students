...
// Fetch all stories videos
$query = "SELECT * FROM videos WHERE category = 'stories'";
$stmt = $pdo->query($query);
$storiesVideos = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    <header class="header">
        ...
        <nav class="navbar">
            <a href="englishdash.php">Dashboard</a>
            <a href="logout.php">Logout</a>
        </nav>
    </header>
    <div class="mvid">
        <h1>Stories Videos</h1>
        <?php if (!empty($storiesVideos)): ?>
            <ul>
                <?php foreach ($storiesVideos as $video): 
        ...
        <?php else: ?>
            <p style="text-align: center; font-size: 18px; color: #888;">No stories videos found.</p>
        <?php endif; ?>
    </div>
    <script>
